...
namespace Facturi.Web.Tests
{
    public abstract class FacturiWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static FacturiWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(FacturiWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<FacturiDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<FacturiDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<FacturiDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<FacturiDbContext, Task<T>> func)
        {
            T result;
