...
namespace Facturi.Migrations
{
    ...
    [Migration("20220114134619_make CatalogueId property a foreign key for InvoiceItem and EstimateItem entities - fix foreign key conflicts 3")]
    partial class makeCatalogueIdpropertyaforeignkeyforInvoiceItemandEstimateItementitiesfixforeignkeyconflicts3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Facturi.App.Client", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<string>("DeviseFacturation")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<float>("RemisePermanente")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("Facturi.App.Devis", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<int>("EcheancePaiement")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Facturi.App.Facture", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Facturi.App.FactureInfosPaiement", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("FactureInfosPaiements");
                });
            ...
            modelBuilder.Entity("Facturi.App.InfosEntreprise", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Facturi.Core.App.Country", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Facturi.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Facturi.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Facturi.App.Devis", b =>
                {
                    b.HasOne("Facturi.App.Client", "Client")
                        .WithMany()
